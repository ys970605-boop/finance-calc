...
REELS_POSTS = [
    {
        "slides": [
            ...
            {"title": "내 실수령액 계산",       "body": "finance-calc-kr.netlify.app"},
        ],
        "caption": "연봉 4000만원 실수령액 알아?\n\n세금 다 떼면 월 286만원밖에 안 남아\n\n내 실수령액 계산해봐 👇\nfinance-calc-kr.netlify.app\n\n#재테크 #실수령액 #월급 #직장인",
    },
    {
        "slides": [
            ...
            {"title": "미리 계산해봐",         "body": "finance-calc-kr.netlify.app"},
        ],
    ...
    },
    {
        "slides": [
            ...
            {"title": "대출이자 계산",         "body": "finance-calc-kr.netlify.app"},
        ],
